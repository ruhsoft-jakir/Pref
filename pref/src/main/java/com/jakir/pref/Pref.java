...
public class Pref {
    ...
    public static void setInt( String key, int data,Context context){
        SharedPreferences.Editor editor = context.getSharedPreferences(key,Context.MODE_PRIVATE).edit();
        editor.putInt(key,data);
        editor.apply();
    }
    ...
    public static void setInt_default1( String key,int data, Context context){
        SharedPreferences.Editor editor = context.getSharedPreferences(key,Context.MODE_PRIVATE).edit();
        editor.putInt(key,data);
        editor.apply();
    }
    public static int getInt_default1(String key, Context context){
        SharedPreferences preferences = context.getSharedPreferences(key,Context.MODE_PRIVATE);
        return  preferences.getInt(key,1);
    }
    public static void setInt_default_1(String key, int data, Context context){
        SharedPreferences.Editor editor = context.getSharedPreferences(key,Context.MODE_PRIVATE).edit();
        editor.putInt(key,data);
        editor.apply();
    }
    public static int getInt_default_1(String key, Context context){
        SharedPreferences preferences = context.getSharedPreferences(key,Context.MODE_PRIVATE);
        return  preferences.getInt(key,-1);
    }
    ...
    public static void setFloat_default1( String key,float data, Context context){
        SharedPreferences.Editor editor = context.getSharedPreferences(key,Context.MODE_PRIVATE).edit();
        editor.putFloat(key,data);
        editor.apply();
    }
    public static float getFloat_default1(String key, Context context){
        SharedPreferences preferences = context.getSharedPreferences(key,Context.MODE_PRIVATE);
        return  preferences.getFloat(key,1);
    }
    public static void setState( String key,boolean data, Context context){
        SharedPreferences.Editor editor = context.getSharedPreferences(key,Context.MODE_PRIVATE).edit();
        editor.putBoolean(key,data);
        editor.apply();
    }
    ...
    public static void setState_defaultP( String key,boolean data, Context context){
        SharedPreferences.Editor editor = context.getSharedPreferences(key,Context.MODE_PRIVATE).edit();
        editor.putBoolean(key,data);
        editor.apply();
    }
    public static boolean getState_defaultP(String key,Context context){
        SharedPreferences preferences = context.getSharedPreferences(key,Context.MODE_PRIVATE);
        return  preferences.getBoolean(key,true);
